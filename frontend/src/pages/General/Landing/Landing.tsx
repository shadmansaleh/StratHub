...
const Hero_1 = () => (
  <div className="hero min-h-screen">
    <div className="hero-content flex-col lg:flex-row gap-10 lg:gap-24 max-w-[90vw]">
      <div>
        ...
        <div className="flex justify-center gap-4 flex-col sm:flex-row md:gap-10">
          ...
          <button
            ...
            className="btn btn:md xl:btn-lg btn-outline btn-primary text-xl xl:text-2xl font-light  c-hover-enlarge"
          >
            Learn More
          </button>
        </div>
      ...
      <img
        src={hero_img}
        className="lg:max-w-[50%] max-w-full rounded-3xl shadow-2xl c-hover-enlarge"
      />
    </div>
  </div>
);
...
const Hero_2 = () => (
  <div className="hero min-h-screen">
    <div className="hero-content flex-col-reverse lg:flex-row  gap-10 lg:gap-24 max-w-[90vw]">
      <img
        src={hero_img2}
        className="lg:max-w-[50%] max-w-full rounded-3xl shadow-2xl c-hover-enlarge"
      />
...
const PointerCards = () => (
  <div className="grid place-items-center min-h-screen m-auto w-full xl:w-[75%]">
    <div className="flex items-center justify-evenly gap-[4rem] flex-wrap">
      <DescCard
        icon={desc_logo1}
