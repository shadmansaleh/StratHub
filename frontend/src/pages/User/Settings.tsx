...
const Settings: React.FC = () => {
  ...
  const handleNotificationToggle = () => {
    setUserData({ ...userData, receiveNotifications: !userData.receiveNotifications });
    ...
    <div className="container mx-auto mt-8 px-4">
      ...
      <div className="bg-base-200 dark:bg-base-800 p-4 rounded-lg mb-4">
        ...
        <div className="flex items-center mb-2">
          <img src={userData.profilePicture} alt="Profile" className="w-12 h-12 rounded-full mr-4" />
          <div>
      ...
      {/* Account Settings */}
      <div className="bg-base-200 dark:bg-base-800 p-4 rounded-lg mb-4">
        <h2 className="text-lg font-semibold text-primary mb-2">Account Settings</h2>
        ...
        <div className="flex items-center justify-between">
          ...
          <label className="switch">
            <input type="checkbox" checked={userData.receiveNotifications} onChange={handleNotificationToggle} />
      ...
      <div className="bg-base-200 dark:bg-base-800 p-4 rounded-lg mb-4">
        ...
        <div className="flex items-center justify-between mb-2">
          <p>Theme</p>
          <select className="select select-bordered max-w-[10rem]" value={userData.selectedTheme} onChange={(e) => handleThemeChange(e.target.value)}>
        ...
        <div className="flex items-center justify-between mb-2">
          <p>Language</p>
          <select className="select select-bordered max-w-[10rem]" value={userData.selectedLanguage} onChange={(e) => handleLanguageChange(e.target.value)}>
      ...
      {/* Privacy Settings */}
      <div className="bg-base-200 dark:bg-base-800 p-4 rounded-lg mb-4">
        <h2 className="text-lg font-semibold text-primary mb-2">Privacy Settings</h2>
        <div className="flex items-center justify-between mb-2">
          <p>Profile Visibility</p>
          <select className="select select-bordered max-w-[10rem]" value={userData.selectedProfileVisibility} onChange={(e) => handleProfileVisibilityChange(e.target.value)}>
        ...
        <div className="flex items-center justify-between">
          ...
          <select className="select select-bordered max-w-[10rem]" value={userData.selectedContactVisibility} onChange={(e) => handleContactVisibilityChange(e.target.value)}>
